...
const translations = {
  es: {
    ...
    'casestudy.title': 'De plataforma limitada a máquina de ventas: Transformamos "Can Ramos"',
    'casestudy.subtitle': 'Cómo una carnicería gourmet escapó de las limitaciones de Wix y empezó a convertir el tráfico que ya tenía.',
    'casestudy.challenge.title': 'El Problema Real',
    'casestudy.challenge.description': 'Can Ramos ya tenía ventas y tráfico, pero su tienda en Wix los estaba frenando. Carga lenta, checkout confuso, estructura rígida de productos, diseño genérico que no reflejaba su esencia, sin estrategias de upselling y cero automatización en email marketing. Sabían que podían vender más con lo que ya tenían, pero la plataforma no les dejaba crecer. Cada visita mal aprovechada era dinero dejado sobre la mesa.',
    'casestudy.solution.title': 'Lo Que Hicimos',
    'casestudy.solution.description': 'Migramos todo a Shopify sin perder un solo dato ni interrumpir las ventas. Diseñamos una tienda que refleja su identidad argentina auténtica, reorganizamos la arquitectura de productos, implementamos upsells estratégicos en checkout, configuramos un welcome flow automatizado para convertir suscriptores en compradores, aceleramos los tiempos de carga y automatizamos procesos clave. Resultado: una tienda profesional que vende más a cada cliente y construye relaciones desde el primer contacto.',
    'casestudy.results.title': 'El Impacto',
    'casestudy.result1': 'Diseño profesional alineado con la identidad de marca: más confianza, más conversiones',
    'casestudy.result2': 'Welcome flow automatizado generando ventas mientras duermen',
    'casestudy.result3': 'Ticket promedio aumentado con upsells inteligentes en checkout',
    'casestudy.result4': 'Velocidad de carga mejorada drásticamente: menos abandonos en checkout',
    'casestudy.result5': 'Migración impecable: productos, clientes y SEO preservados al máximo posible',
    'casestudy.expertise.title': 'Cómo Lo Logramos',
    'casestudy.expertise.description': 'Nada de improvisación. Seguimos un método probado: auditamos qué estaba frenando las conversiones, diseñamos una experiencia visual que conecta con su audiencia, implementamos estrategias de cross-selling, upselling y email marketing automatizado, testeamos cada detalle y migramos en un momento estratégico. Las ventas continuaron sin interrupciones y ahora tienen un sistema que trabaja para ellos 24/7.',
    'casestudy.expertise.tag1': 'Diseño con identidad',
    'casestudy.expertise.tag2': 'Email marketing automatizado',
    'casestudy.expertise.tag3': 'Ticket promedio aumentado',
    'casestudy.cta.title': '¿Tu tienda te está limitando?',
    'casestudy.cta.description': 'Si tienes tráfico pero sientes que deberías estar vendiendo más y aprovechando mejor cada cliente, el problema no eres tú ni tu producto. Hablemos y te mostramos exactamente qué está frenando tus conversiones.',
    'casestudy.cta.button': 'Contactar para consulta gratuita',
    'casestudy.cta.viewcase': 'Ver tienda del caso',
  ...
  en: {
    ...
    'casestudy.title': 'From Limited Platform to Sales Machine: We Transformed "Can Ramos"',
    'casestudy.subtitle': 'How a gourmet butcher shop escaped Wix limitations and started converting the traffic they already had.',
    'casestudy.challenge.title': 'The Real Problem',
    'casestudy.challenge.description': 'Can Ramos already had sales and traffic, but their Wix store was holding them back. Slow loading, confusing checkout, rigid product structure, generic design that didn\'t reflect their essence, no upselling strategies and zero email marketing automation. They knew they could sell more with what they already had, but the platform wouldn\'t let them grow. Every wasted visit was money left on the table.',
    'casestudy.solution.title': 'What We Did',
    'casestudy.solution.description': 'We migrated everything to Shopify without losing a single piece of data or interrupting sales. We designed a store that reflects their authentic Argentine identity, reorganized the product architecture, implemented strategic upsells at checkout, configured an automated welcome flow to convert subscribers into buyers, accelerated loading times and automated key processes. Result: a professional store that sells more to each customer and builds relationships from the first contact.',
    'casestudy.results.title': 'The Impact',
    'casestudy.result1': 'Professional design aligned with brand identity: more trust, more conversions',
    'casestudy.result2': 'Automated welcome flow generating sales while they sleep',
    'casestudy.result3': 'Average ticket increased with intelligent checkout upsells',
    'casestudy.result4': 'Loading speed dramatically improved: fewer checkout abandonments',
    'casestudy.result5': 'Flawless migration: products, customers, and SEO preserved to the maximum extent possible',
    'casestudy.expertise.title': 'How We Did It',
    'casestudy.expertise.description': 'No improvisation. We followed a proven method: we audited what was slowing conversions, designed a visual experience that connects with their audience, implemented cross-selling, upselling and automated email marketing strategies, tested every detail and migrated at a strategic moment. Sales continued uninterrupted and now they have a system that works for them 24/7.',
    'casestudy.expertise.tag1': 'Design with identity',
    'casestudy.expertise.tag2': 'Automated email marketing',
    'casestudy.expertise.tag3': 'Increased average ticket',
    'casestudy.cta.title': 'Is your store limiting you?',
    'casestudy.cta.description': 'If you have traffic but feel you should be selling more and making better use of each customer, the problem isn\'t you or your product. Let\'s talk and We\'ll show you exactly what\'s holding back your conversions.',
    'casestudy.cta.button': 'Contact for free consultation',
    'casestudy.cta.viewcase': 'View Case Study',
