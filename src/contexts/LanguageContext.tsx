...
const translations = {
  es: {
    ...
    'hero.stat1.label': 'conversiones al mes — trabajamos con webs de bajo tráfico',
    'hero.stat2.label': 'migración completa a Shopify, llave en mano',
    'hero.stat3.num': 'IA',
    'hero.stat3.label': 'procesos nivel enterprise',
    ...
    'whom.item3': 'Vendas o quieras migrar a Shopify, el punto de partida es el mismo: entender bien tu tienda antes de tocar nada.',
    ...
    'services.swipeHint': 'Desliza para ver más',
    ...
    'services.conversionAudit.tagline': 'Tienda completa 450€ + iva',
    ...
    'services.requestAudit': 'Pedir auditoría',
    ...
    'casestudy.swipeHint': 'Desliza para ver el otro caso',
    'casestudy.screenshotAlt': 'Captura de la home de la tienda',
    'casestudy.card1.title': 'Can Ramos',
    'casestudy.card1.bullet1': 'De Wix estancado a Shopify que vende solo',
    'casestudy.card1.bullet2': 'Migración completa sin perder ventas',
    'casestudy.card1.bullet3': 'Checkout optimizado + welcome flow automático',
    'casestudy.card2.title': 'Termolar',
    'casestudy.card2.bullet1': 'Tienda nueva, creada desde cero',
    'casestudy.card2.bullet2': 'Venta a toda Europa',
    'casestudy.card2.bullet3': 'Operativa en 1 mes y medio',
    ...
    'casestudy.cta.button': 'Hablemos 15 minutos',
    ...
    'relatedServices.services.conversionAudit.description': 'Tu tienda completa',
  ...
  en: {
    ...
    'hero.stat3.num': 'AI',
    'hero.stat3.label': 'enterprise-level processes',
    ...
    'services.conversionAudit.tagline': 'Full store, €450 + VAT',
    ...
    'casestudy.screenshotAlt': 'Screenshot of the store home page',
    'casestudy.card1.title': 'Can Ramos',
    'casestudy.card1.bullet1': 'From a stuck Wix store to a Shopify that sells itself',
    'casestudy.card1.bullet2': 'Full migration with zero sales loss',
    'casestudy.card1.bullet3': 'Optimized checkout + automatic welcome flow',
    'casestudy.card2.title': 'Termolar',
    ...
    'relatedServices.services.conversionAudit.description': 'Your entire store',
    'relatedServices.services.emailAutomation.title': 'Email marketing automation',
