        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto font-light">
              Modificaciones avanzadas para hacer único tu tema de Shopify
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center p-8 rounded-xl border border-gray-700 hover:border-orange-300 transition-all duration-300 hover:bg-gray-800/50">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-white mb-3" style={{ fontFamily: "Bebas Neue, sans-serif" }}>DISEÑO Y LAYOUT</h3>
              <p className="text-gray-300 leading-relaxed">
                Layouts personalizados y diseños únicos adaptados a tu marca
              </p>
            </div>
            ...
            <div className="text-center p-8 rounded-xl border border-gray-700 hover:border-orange-300 transition-all duration-300 hover:bg-gray-800/50">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-white mb-3" style={{ fontFamily: "Bebas Neue, sans-serif" }}>FUNCIONALIDADES CUSTOM</h3>
              <p className="text-gray-300 leading-relaxed">
                Desarrollo de funcionalidades específicas para tu negocio
              </p>
            </div>
            ...
            <div className="text-center p-8 rounded-xl border border-gray-700 hover:border-orange-300 transition-all duration-300 hover:bg-gray-800/50">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-white mb-3" style={{ fontFamily: "Bebas Neue, sans-serif" }}>SECCIONES NUEVAS</h3>
              <p className="text-gray-300 leading-relaxed">
                Secciones completamente nuevas y únicas para tu tienda
              </p>
            </div>
            ...
            <div className="text-center p-8 rounded-xl border border-gray-700 hover:border-orange-300 transition-all duration-300 hover:bg-gray-800/50">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-white mb-3" style={{ fontFamily: "Bebas Neue, sans-serif" }}>OPTIMIZACIÓN</h3>
              <p className="text-gray-300 leading-relaxed">
                Optimización de rendimiento y velocidad de carga del tema
              </p>
            </div>
            ...
            <div className="text-center p-8 rounded-xl border border-gray-700 hover:border-orange-300 transition-all duration-300 hover:bg-gray-800/50">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-white mb-3" style={{ fontFamily: "Bebas Neue, sans-serif" }}>INTEGRACIONES</h3>
              <p className="text-gray-300 leading-relaxed">
                Integración avanzada con apps y servicios de terceros
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto font-light">
              Cómo transformamos tu tema de Shopify paso a paso
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center group">
              ...
              <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-3" style={{ fontFamily: "Bebas Neue, sans-serif" }}>ANÁLISIS Y PLANIFICACIÓN</h3>
              <p className="text-gray-600 leading-relaxed">Evaluamos tu tema actual y planificamos las modificaciones</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-3" style={{ fontFamily: "Bebas Neue, sans-serif" }}>DESARROLLO</h3>
              <p className="text-gray-600 leading-relaxed">Desarrollo de las personalizaciones en ambiente de pruebas</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-3" style={{ fontFamily: "Bebas Neue, sans-serif" }}>TESTING Y AJUSTES</h3>
              <p className="text-gray-600 leading-relaxed">Pruebas exhaustivas y ajustes basados en feedback</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-3" style={{ fontFamily: "Bebas Neue, sans-serif" }}>IMPLEMENTACIÓN</h3>
              <p className="text-gray-600 leading-relaxed">Despliegue final y documentación de las personalizaciones</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20" style={{ backgroundColor: '#141417ff' }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6 tracking-tight" style={{ fontFamily: "Bebas Neue, sans-serif" }}>
            ¿LISTO PARA CREAR UN
            <br />
            <span className="text-orange-300">TEMA ÚNICO?</span>
          </h2>
          <p className="text-lg md:text-xl text-gray-300 mb-8 max-w-3xl mx-auto font-light leading-relaxed">
            Obtén una personalización profesional que haga destacar tu tienda Shopify de la competencia
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              href="/es/contacto" 
