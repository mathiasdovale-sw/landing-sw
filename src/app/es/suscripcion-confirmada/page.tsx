    ...
    switch (status) {
      case 'success':
        return {
          ...
          message: 'Gracias por suscribirte a nuestro newsletter. Recibirás contenido valioso sobre Shopify y ecommerce.',
          type: 'success'
        }
      ...
      default:
        return {
          ...
          message: 'Hubo un problema al procesar tu suscripción. Por favor, inténtalo de nuevo.',
          type: 'error'
        }
    }
  }
